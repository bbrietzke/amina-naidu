...
CREATE TABLE IF NOT EXISTS Announcements(Id INTEGER PRIMARY KEY, Content TEXT, WeekOf INTEGER, Day INTEGER, MessageId TEXT NULL, CreatedOn DATETIME DEFAULT CURRENT_TIMESTAMP);

CREATE TABLE IF NOT EXISTS Feeds(Id INTEGER PRIMARY KEY, Url TEXT UNIQUE, Title TEXT UNIQUE);
CREATE TABLE IF NOT EXISTS FeedEntries(Id INTEGER PRIMARY KEY, FeedId INTEGER, MessageId TEXT NULL, Title TEXT, Url TEXT UNIQUE);

CREATE TABLE IF NOT EXISTS Leagues(Id INTEGER PRIMARY KEY, Name TEXT, StartsOn TEXT, EndsOn TEXT, CreatedOn DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE IF NOT EXISTS LeaguePlayer(Id INTEGER PRIMARY KEY, PlayerId INTEGER, LeagueId INTEGER, CreatedOn DATETIME DEFAULT CURRENT_TIMESTAMP);
'''
...
UPDATE_GAME = "UPDATE Games SET Url = ?, Title = ?, StartWeek = ?, MessageId = ? WHERE Id = ?;"
...
SELECT_CURRENT_GAME_NULL_MESSAGE = "SELECT Id, Url, Title, StartWeek, MessageId FROM Games WHERE StartWeek = ? AND MessageId IS NULL;"
