...
CREATE TABLE IF NOT EXISTS Feeds(Id INTEGER PRIMARY KEY, Url TEXT UNIQUE);
CREATE TABLE IF NOT EXISTS FeedEntries(Id INTEGER PRIMARY KEY, FeedId INTEGER, Title TEXT, Url TEXT, MessageId TEXT NULL);
